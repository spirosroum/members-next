...
export const useAdminStore = defineStore('admin', () => {
  ...
  return {
    ...
    bin: memberAdminApi.bin,
    signIn, signOut, memberStatus, isUnpaid, startCheckin, confirmCheckin, checkout,
    saveCheckinNotice: settingsApi.saveCheckinNotice,
    savePortalName: settingsApi.savePortalName, saveCurrency: settingsApi.saveCurrency,
    saveAttendanceColors: settingsApi.saveAttendanceColors,
